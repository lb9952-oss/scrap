# -*- coding: utf-8 -*-
# 통합 실행 스크립트 v8 (최종): run_all_in_one.py
# 기능: 최상위 경로 구조에 맞춰 동적 크롤링, 중복 제거, 스크랩 가치 예측, 정적 파일 생성을 모두 수행합니다.
...
def generate_static_files():
    ...
    # HTML 파일은 이미 올바른 JS를 참조하므로 별도 처리하지 않음.
    print("  [2/3] HTML 파일 처리 건너뜀 (index.html이 이미 올바른 스크립트를 참조).")
