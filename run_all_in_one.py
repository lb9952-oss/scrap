1 # -*- coding: utf-8 -*-
     2 # 통합 실행 스크립트 v7 (최종): run_all_in_one.py
    ...
    35 HTML_TEMPLATE_FILE = os.path.join(BASE_DIR, 'index.html') # 템플릿으로 사용할 원본 index.html
    36 HTML_OUTPUT_FILE = os.path.join(BASE_DIR, 'index.html')   # 덮어쓸 최종 index.html
